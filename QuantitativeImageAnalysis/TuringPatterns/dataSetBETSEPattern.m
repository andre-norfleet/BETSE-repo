...
folderName = 'Z:\Andre\2021 BETSE Sim Output\Norm59';
mkdir(folderName);
folderName = [folderName, 'Ex49BETSE'];
mkdir(folderName);


arffFile = [folderName, '498train_weka32today.arff']; % THE WEKA FILE
% arffFile = [folderName, 'test_weka32.arff']; % THE WEKA FILE
filename = 'Z:/Andre/2021 BETSE Output/Norm59/498train_weka32today.arff';
...
positiveimagefolder1 = 'Z:\Andre\2021 BETSE Sim Output\Normautoscale';
...
negativeimagefolder1 = 'Z:\Andre\2021 BETSE Sim Output\GJbetaGA75decAutoscale';
...
negativeimagefolder2 = 'Z:\Andre\2021 BETSE Sim Output\GJBlock501';
...
negativeimagefolder4 = 'Z:\Andre\2021 BETSE Sim Output\K20Supp1Autoscale';
...
negativeimagefolder6 = 'Z:\Andre\2021 BETSE Sim Output\GJbetaGA25decAutoscale';
...
for ii=1:len
    ...
    tree{1} = calculateQuadtree(negdata6);
    saveARFFTree(arffFile, tree, 1, labels, 'NP', depth);
end

%negativeimagefolder5 = 'Z:\Andre\2021 BETSE Sim Output\GJBlock501';
