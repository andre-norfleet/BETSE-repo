...
folderName = 'Z:\Andre\2021 BETSE Sim Output\Norm111';
mkdir(folderName);
folderName = [folderName, 'Ex101aBETSE'];
mkdir(folderName);


arffFile = [folderName, '1018train_weka32today.arff']; % THE WEKA FILE and arff file enconding P and NP QTSs for dataset
% arffFile = [folderName, 'test_weka32.arff']; % THE WEKA FILE
%filename = 'Z:/Andre/2021 BETSE Output/Norm111/1018train_weka32today.arff';
arffFile = [folderName, '1018train_weka32today.arff'];
...
labels = {'Rm','Rv'}; % Rm : stands for Red mean, 
...
negativeimagefolder1 = 'Z:\Andre\2021 BETSE Sim Output\K20Supp1Autoscale';
...
%negativeimagefolder2 = 'Z:\Andre\2021 BETSE Sim Output\NormAutoscale';
