...
def configure_diffusivity_const():
    ...
    C['gap junction surface area'] = config['variable settings']['gap junctions']['gap junction surface area']
...
#    output_folder = "%s_%s_%s_%s_%s_%s_%s_%s_%s" % (args.Dm_K,args.value_1,args.Dm_Na,args.value_2,args.Dm_Cl,args.value_3,args.gap_junction_surface_area,args.value_4,args.try_number)
    output_folder = "%s_%s_%s_%s_%s" % (args.Dm_K,args.value_1,args.Dm_Na,args.value_2,args.try_number) # Must edit if one parameter modified
