...
imageFolder = 'Z:\Andre\2021 in vitro outcomes\Ctrlall_3';
load('InVitrobGA60all_112721formulamatfile.mat', 'ans');
formula = ans;
color = 1;
outputFile = 'Z:\Andre\Code\TuringPatterns\135thtestoutput';
